use crate::app::models::{AppStatus, RunningApps};
...
pub struct RuntimeRegistry {
    ...
    pub(crate) running_apps_statuses: HashMap<String, AppStatus>,
...
impl RuntimeRegistry {
    ...
    pub fn contains_app(&self, app_key: &str) -> bool {
        self.running_apps
            .try_read()
    ...
    pub fn add_pid_to_existing_app(&self, app_key: &str, pid: u32) -> bool {
        match self.running_apps.try_write() {
            Ok(mut apps) => {
