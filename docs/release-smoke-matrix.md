...
| **Crash reports** Activity control and list | The Activity action opens the report subpage and lists newest reports first without blocking the render path | Yes |
