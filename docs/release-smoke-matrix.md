...
| Auto Re-apply toggle and notifications | Auto Re-apply state can be toggled, corrections still apply when enabled, and expected notifications or logs appear | Yes |
