...
- Auto Re-apply App Process Affinity behavior that can restore app process settings after launch

It is not trying to be a full replacement for every Windows process automation tool.

## Comparison table

| Tool | Saved launch rules | Auto Re-apply App Process Affinity | Convenience | Complexity | Cost / availability | Scope |
| --- | --- | --- | --- | --- | --- | --- |
